...
export default function CounterSection() {
  ...
  return (
    <section className="pt-8 pb-24 md:pb-32 bg-lars-navy relative overflow-hidden">
      ...
      <div className="absolute bottom-0 left-0 w-full overflow-hidden leading-none rotate-180 text-white z-0 -mb-[1px]">

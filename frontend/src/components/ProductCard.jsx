      ...
      >
        <div className="relative aspect-square overflow-hidden bg-lars-sand" style={{ transform: "translateZ(30px)" }}>
          ...
          <button
            ...
            className="absolute top-4 right-4 z-30 p-2 rounded-full bg-white/80 backdrop-blur shadow-sm hover:bg-white hover:scale-110 transition-all text-red-500 cursor-pointer"
          >
            <Heart size={20} fill={isFavorite ? "currentColor" : "none"} />
          </button>
          <div className="absolute inset-0 bg-lars-navy/40 opacity-0 group-hover:opacity-100 transition-opacity duration-300 flex flex-col items-center justify-center pointer-events-none">
            <button 
